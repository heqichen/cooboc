...
void Bmx055Driver::resetAcc(void)
{
	...
	mIicHandler->writeU8(ACC_ADDR, ACC_SOFTRESET_ADDR, 0xB6);
	//set range to += 16g
	//datasheet page 57.
	mIicHandler->writeU8(ACC_ADDR, ACC_RANGE_ADDR, 0b00001100);
}

void Bmx055Driver::resetGyro(void)
{
	//soft reset gyro
	mIicHandler->writeU8(GYRO_ADDR, GYRO_SOFTRESET_ADDR, 0xB6);
	//set range to +=1000degree/s
	//datasheet page 99.
	mIicHandler->writeU8(GYRO_ADDR, GYRO_RANGE_ADDR, 0b0000001);
}
